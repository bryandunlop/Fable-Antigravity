    ...
    switch (userRole) {
      ...
      case 'maintenance':
        return [
          ...
          { label: 'AOG Declaration', icon: AlertTriangle, href: '/tech-log/aog', color: 'bg-red-500 hover:bg-red-600', urgent: true },
      ...
      case 'scheduling':
        return [
          { label: 'Flight Ops Center', icon: Monitor, href: '/flight-operations-center', color: 'bg-primary hover:bg-primary/90' },
          { label: 'Add Flight', icon: Calendar, href: '/scheduling', color: 'bg-blue-500 hover:bg-blue-600' },
