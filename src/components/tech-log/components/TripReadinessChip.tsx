...
const MAP: Record<TripReadiness, { label: string; dot: string; text: string }> = {
  READY:     { label: 'Ready',        dot: 'bg-[var(--gfo-success,#00B140)]', text: 'text-[var(--gfo-success-ink,#00803A)]' },
  NOT_READY: { label: 'Almost ready', dot: 'bg-[var(--gfo-warning,#F1B434)]', text: 'text-[var(--gfo-warning-ink,#8A6200)]' },
  RED:       { label: 'Not ready',    dot: 'bg-[var(--gfo-error,#EF3340)]',   text: 'text-[var(--gfo-error-ink,#C81E2B)]' },
};
