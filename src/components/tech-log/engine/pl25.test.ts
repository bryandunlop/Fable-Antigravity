...
describe('PL-25 clock', () => {
  ...
  it('Cat C (10 day) discovered Jan 26 10:00 -> due Feb 6 00:00 UTC (true PL-25, end of final day)', () => {
    ...
    expect(due.repairDueDateUtc).toBe('2026-02-06T00:00:00.000Z');
  ...
  it('Cat B (3 day) calendar due date', () => {
    ...
    expect(due.repairDueDateUtc).toBe('2026-03-05T00:00:00.000Z');
  });
  ...
  it('category fallback: Cat D with no explicit interval -> 120 days', () => {
    ...
    expect(due.repairDueDateUtc).toBe('2026-05-02T00:00:00.000Z');
  });
