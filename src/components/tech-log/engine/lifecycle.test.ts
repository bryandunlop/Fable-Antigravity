...
const AC = 'ac1';
const brief = (p: Partial<FlightBriefing> = {}): FlightBriefing => ({ id: 'b1', aircraftId: AC, preparedByOid: 'm', createdAtUtc: '2026-06-20T00:00:00Z', status: 'DRAFT', ...p });
...
describe('lifecycleStep', () => {
  ...
  it('back to PREFLIGHT after a postflight reclaim', () => {
    const b = brief({ status: 'ACKNOWLEDGED', releasedAtUtc: '2026-06-21T08:00:00Z', acknowledgedAtUtc: '2026-06-21T09:00:00Z' });
    const pf: Postflight = { id: 'pf1', aircraftId: AC, performedByOid: 'm', performedAtUtc: '2026-06-22T07:00:00Z', gatheredDefectIds: [], signatureId: 's' };
