    ...
    <div className="flex flex-col min-h-screen bg-slate-50 w-full pb-20 pt-16 lg:pt-0">
      ...
      <Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
         <DialogContent className="max-w-md">
            ...
            <DialogDescription>Are you sure you want to delete report <strong>{hazard?.id}</strong>? This action cannot be undone.</DialogDescription>
            <DialogFooter>
      ...
      <Dialog open={isVerifyingPII} onOpenChange={setIsVerifyingPII}>
        <DialogContent className="max-w-3xl overflow-y-auto max-h-[90vh] bg-white border-0">
          <DialogHeader>
