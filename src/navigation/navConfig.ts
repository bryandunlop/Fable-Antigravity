...
export const NAV_ENTRIES: readonly NavEntry[] = [
  ...
  { path: '/tech-log', label: 'Tech Log', domain: 'maintenance', icon: FileText, primary: true, keywords: ['squawk', 'defect', 'deferral', 'mel', 'release', 'work card', 'safa'], roles: ['pilot', 'maintenance', 'admin', 'maintenance-coordinator', 'dom', 'reg-comp'] },
